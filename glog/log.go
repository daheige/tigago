...
import (
	...
	"github.com/daheige/tigago/mutexlock"
)
...
func splitLog() {
	...
	if fileInfo.Size() >= defaultMaxSize*megabyte {
		...
		if err := gutils.Chown(logFile, fileInfo); err != nil {
...
// saveLog 写入内容到日志中
func saveLog(levelName string, msg interface{}, options map[string]interface{}) {
